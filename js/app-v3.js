(() => {
  ...
  const BASE_FONT_FAMILIES=['Arial','Arial Narrow','Tahoma','Verdana','Impact','sans-serif'];
  ...
  function fontNorm(value){return String(value||'').normalize('NFKC').trim().toLocaleLowerCase();}
