...
const css = ['css/app.css','css/enhancements.css','css/v3-preview.css','css/ux-redesign.css','css/canvas-v4.css'].map(read).join('\n\n');
...
html = html
  ...
  .replace(/\s*<link rel="stylesheet" href="css\/canvas-v4\.css">/, '')
  .replace('</head>', `\n  <style>\n${css}\n  </style>\n</head>`)
